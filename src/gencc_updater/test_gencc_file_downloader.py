...
from gencc_file_downloader import *
...
def test_trim_line(split_lines, expected):
    assert expected == trim_line(split_lines)
...
@mock.patch(
    "gencc_file_downloader.read_gencc_file",
    return_value={
...
@mock.patch(
    "gencc_file_downloader.download_gencc_file",
    return_value="/home/ubuntu/path/to/download/raw_filename.tsv",
)
@mock.patch(
    "gencc_file_downloader.read_config_file",
    return_value={
        "GenCC": {
